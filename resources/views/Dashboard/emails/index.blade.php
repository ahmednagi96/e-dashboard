        ...
        <div class="card-datatable table-responsive">
          <table class="datatables-users table">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $email->id }}</td>
                   {{-- <td> <img src="{{ asset('storage/'.$email->img ) }}" alt=""> {{ Storage::url($email->img)}} {{ asset('storage/' . $email->photo) }}</td> --}}
                   {{-- <td>
                        <img src="{{ $email->img ? asset('storage/' . $email->img) : asset('avater.png') }}" class="img-fluid rounded-circle" width="60px" height="60px" alt="{{ asset('assets/img/avatars/1.png') }}"/>
                     </td> --}}
                    <td>{{ $email->email }}</td>
                    {{-- <td>{{ $email->title }}</td> --}}
                    {{-- <td>
