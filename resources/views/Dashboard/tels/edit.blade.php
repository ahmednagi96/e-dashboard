...
<div class="container pt-5">
    <div class="card shadow-sm border-0">
        ...
        <div class="card-body">
            <form class="add-new-user" id="addNewUserForm" action="{{ route('tels.update',$tel->id) }}" method="POST"  >
                @csrf
                @method('PUT')
                <div class="row ">
                    <!-- Name Field -->
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" id="add-user-fullname" placeholder="اضف عنوان" value="{{ $tel->title }}" name="title" >
                        @error('title')
                    ...
                    <div class="col-12">
                        ...
                        <input type="phone" class="form-control" id="add-user-fullname" placeholder="اضف رقم" name="phone" value="{{ $tel->phone }}" required>
                        @error('phone')
                        <div class="alert alert-danger mt-2">{{ $message }}</div>
                        @enderror
                    </div>
